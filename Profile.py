...
# You should review this code to identify
...
class Profile:
    ...
    it to the posts list. Posts are stored in a list object in
    ...
    search operation on the posts returned from the get_posts function
    ...
    get_posts returns the list object containing all posts that have
